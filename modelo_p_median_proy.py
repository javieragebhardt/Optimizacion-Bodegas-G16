...
import construccion_datos_proy
import folium
...
class LocalizacionOptima:
    ...
    def __init__(self, p, d):
        # Parámetros
        self.p = p
        self.h = construccion_datos_proy.h
        self.d = d
        if self.d == construccion_datos_proy.d_Manhattan:
            self.tipo_distancia = 'Manhattan'
        elif self.d == construccion_datos_proy.d_mapbox:
            self.tipo_distancia = 'Mapbox'
        else:
            self.tipo_distancia = 'Segunda Bodega'
        self.rutas = construccion_datos_proy.rutas
        self.resultados = dict()
        # Conjuntos
        self.I = construccion_datos_proy.I
        self.J = construccion_datos_proy.J
        # Modelo
        self.m = Model()
        # Variables
    ...
    def generar_mapa(self):
        dict_bodegas = construccion_datos_proy.dict_bodegas
        ...
        dict_clientes = construccion_datos_proy.dict_ventas
    ...
    def calcular_tiempos(self):
        ventas = construccion_datos_proy.dict_ventas
        for i in self.I:
...
for p in [3]:
    ...
    LocalizacionOptima(p, construccion_datos_proy.d_Manhattan).resolver()

#TO DO FALTA CORRER CASOS PARA DISTINTA CATEGORICACIÓN mapbox y v = 30 km/hr p=10, p= 5 y p= 3
